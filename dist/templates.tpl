...
<script type="text/x-handlebars-template" id="framework-template"><script type="text/x-handlebars-template" id="framework-template">
	<!--
	<ul class="graphic">
		<li class="profit">
			<span>$ 428.00</span>
	...
	<div class="welcome box-violet">
		<div class="content">
			<h1>Welcome</h1>
			<span class="text-body">Since this is your first using TradingLog, you need to create an account that you´lobe trading with. You´ll be able to add or edit accounts later on.</span>
			<form>

				<div class="wrapper-input">
					<input type="" placeholder="Account name">
					<span class="help-block">For example, &#39;Demo&#39;, &#39;Real&#39;, etc.</span>
				</div>

				<div class="wrapper-input">
					<div class="input-icon price">
						<input type="" placeholder="Initial balance">
					</div>
			...
			<div class="button-primary">Continue</div>
		</div>
		<div class="video"></div>
	</div>
	...
	<ul>
		<li class="wrapper-label">
			<div class="label trade open long swipe">
				<div class="ball">
					<div class="icon"></div>
				</div>
				<div class="row">
	...
	<ul>
		<li class="wrapper-label">
			<div class="label trade long swipe">
				<div class="ball">
					<div class="icon"></div>
				</div>
				<div class="row">
					<div class="instrument">E-mini S&P 500</div>
					<div class="net positive">$ 104.24</div>
				</div>
				<div class="row">
		...
		<li class="wrapper-label">
			...
			<div class="wrapper-swipe">
				<div class="swipe-buttons">
					<ul>
						<li class="button-swipe delete"></li>
						<li class="button-swipe delete-photo"></li>
					</ul>
				</div>
			</div>
		</li>
	...
	<div class="box-violet">
		...
		<span class="copyright">TradingLog @ 2014<br>
	...
	<div class="box-violet">
		<ul class="wrapper-feedback">
			...
			<li class="button-feedback happy active"></li>
	...
	<div class="header-box-swipe">
		<div class="wrapper-calendar">
			...
			<div class="calendar end-right">88/88/88 - 88/88/88</div>
		</div>
		<ul class="wrapper-radiobutton">
			<li class="group-radiobutton">
				<div class="radiobutton active"></div>
	...
	<div class="box-swipe">
		<ul id="map">
			...
			<li class="wrapper-label">
				<div class="label trade short zero">
					<div class="ball">
						<div class="icon"></div>
					</div>
					<div class="row">
						<div class="instrument">E-mini S&P 500</div>
						<div class="net zero">$ 0.00</div>
					</div>
					<div class="percentage">
