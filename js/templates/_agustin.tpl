<script type="text/x-handlebars-template" id="agustin-template">
		...
		<div class="box-violet">
			...
			<ul>
				<li class="wrapper-label" style="left: -80px; width: 400px;">
					<div class="label account swipe" style="left: 80px; width: 320px;">
	...
	<!--
		...
		<div class="box-swipe box-violet">
			<ul id="map">
				<li class="wrapper-label">
					<div class="label trade long positive">
						<div class="ball">
	...
	<ul>
		...
		<li class="wrapper-label">
			<div class="label trade open short swipe">
				<div class="ball">
					<div class="icon"></div>
				</div>
				<div class="row">
		...
		<li class="wrapper-label">
			<div class="label trade short swipe">
				<div class="ball">
		...
		<li class="wrapper-label">
			<div class="label operation withdraw swipe">
				<div class="ball">
					<div class="icon"></div>
				</div>
				<div class="row">
