<script type="text/x-handlebars-template" id="main-map-template">
	<section id="content">
		<ul id="map">
			{{#each trades}}
				<li class="wrapper-label">
					<div class="label trade {{#if this.isLong}}long{{else}}short{{/if}} {{#gt this.net 0}}positive{{else}}{{#lt this.net 0}}negative{{else}}zero{{/lt}}{{/gt}}">
						...
						<div class="percentage animated fadeInLeft" style="-webkit-animation-delay: {{multiply @index 0.01}}s; -webkit-animation-duration: 0.2s;">
