	...
	app.databaseController = {
		...
		populateDemo: function() {
			var sqls = [
				...
				// 'INSERT INTO trade VALUES (null, 1, ' + (Math.floor(Math.random() * 2) + 1) + ', ' + (Math.floor(Math.random() * 2) + 1) + ', ' + (Math.floor(Math.random() * 100000) + 1) / 100 + ', ' + (Math.floor(Math.random() * 100000) + 1) / 100 + ', 42.4, 5, 0, 1428520308180);',
