				...
				success: function() {
					...
					switch(name) {
						case 'calculator':
							...
							break;
						case 'delete':
							guider.description = 'You\'ll be able to delete trades, operations, positions, etc. under certain conditions only. We added a small triangle at the bottom left of every swipeable element for your convenience.';
